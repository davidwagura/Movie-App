<template>
  ...
  <div class="home">
    ...
    <div class="default-cover">
      ...
      <img src="../../public/cover.webp" alt="Default Cover" class="cover-image" />
    ...
    <div v-if="movies.length > 0" class="movies-list">
      ...
      <div v-for="movie in movies" :key="movie.imdbid" class="movie-card">
        ...
        :src="movie.imageurl && movie.imageurl.length ? movie.imageurl[0] : '../../public/elementor-placeholder-image (1).webp'" 
